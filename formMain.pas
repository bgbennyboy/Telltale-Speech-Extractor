...
uses
  ...
  System.ImageList, AdvStyleIF, Vcl.Mask;
...
type
  TfrmMain = class(TForm)
    ...
    heDefinitiveSeries1: TMenuItem;
    Other1: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeriesMenuVoice: TMenuItem;
    Michonne2: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeriesM103: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeriesM102: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeriesM101: TMenuItem;
    SeasonFour1: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries404: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries403: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries402: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries401: TMenuItem;
    SeasonThree2: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries305: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries304: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries303: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries302: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries301: TMenuItem;
    SeasonTwo1: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries205: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries204: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries203: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries202: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries201: TMenuItem;
    SeasonOne1: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries106: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries105: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries104: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries101: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries102: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeries103: TMenuItem;
    SaveTheWorld1: TMenuItem;
    Menu_SamAndMax_SaveTheWorld_EP6: TMenuItem;
    Menu_SamAndMax_SaveTheWorld_EP5: TMenuItem;
    Menu_SamAndMax_SaveTheWorld_EP4: TMenuItem;
    ...
    DevilsPlayhouse1: TMenuItem;
    Menu_SamAndMax_DevilsPlayhouse_EP5: TMenuItem;
    Menu_SamAndMax_DevilsPlayhouse_EP4: TMenuItem;
    Menu_SamAndMax_DevilsPlayhouse_EP3: TMenuItem;
    Menu_SamAndMax_DevilsPlayhouse_EP2: TMenuItem;
    Menu_SamAndMax_DevilsPlayhouse_EP1: TMenuItem;
